$(document).ready(function () {
    ...
    new ScrollMagic
        .Scene({
            triggerElement: "#achievementsPage",
            duration: "100%"
        })
        .setClassToggle("#achievements-headline", "fade-in-headline")
        .addTo(e);
    new ScrollMagic
        .Scene({
    ...
    new ScrollMagic
        ...
        .setClassToggle("#achievementsPage .lines .top-line", "fade-in-top")
        .addTo(e);
    new ScrollMagic
        .Scene({
            triggerElement: "#achievementsPage",
        ...
        .setClassToggle("#achievementsPage .lines .bottom-line", "fade-in-bottom")
        .addTo(e);
    new ScrollMagic
        .Scene({
            triggerElement: "#contactPage",
    ...
    new ScrollMagic
        ...
        .setClassToggle("#achievementsPage .achievements-info", "fade-in-info")
        .addTo(e);
    new ScrollMagic
        .Scene({
            triggerElement: "#achievementsPage",
        ...
        .setClassToggle("#achievementsPage .achievements-tab", "fade-in-tab")
        .addTo(e);
    new ScrollMagic
        .Scene({
            triggerElement: "#contactPage",
    ...
    new ScrollMagic
        ...
        .setClassToggle("#achievementsPage .grid-layout", "fade-in-grid")
        .addTo(e);
    new ScrollMagic
        .Scene({
            triggerElement: "#achievementsPage",
        ...
        .setClassToggle("#achievementsPage .achievements-up", "fade-in-upgrid")
        .addTo(e);
    new ScrollMagic
        .Scene({
            triggerElement: "#contactPage",
